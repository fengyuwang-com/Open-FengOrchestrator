# FengOrchestrator — 董事长舰队：AI 指挥 AI 编程编排方案研究
...
> 你只当董事长发一句目标＋签审批单。
>
> **两层界面原则（2026-09-13 立规）**：所有系统只留两层——对话层（跟 AI 说话+Skill，承载操作）+ 观景层（只读 UI 给人看）；资料留本地、产出可备份。文档（AGENTS/MISSION/todo/FENGMEM）是对 AI 的治理面。全文见 [fengyuwang_com/TWO-LAYER-INTERFACE.md](../../../fengyuwang_com/TWO-LAYER-INTERFACE.md)。

---

## 状态

✅ 调研完成　✅ 选型锁定　✅ 人才库 263 全量入编（MIT 署名已全量修复，2026-08-23）　✅ 五层架构成型（cao-ceo Skill 一句话触发）　✅ 舰队实战验证（TTS UI 双引擎交付，2026-08-24）　✅ 两层界面原则立规+全生态审查（2026-09-13）
🔄 当前：TTS UI v3 真舰队协同（PM→设计师→开发→QA）收尾中

_日期：2026-08-24 ｜ 执行层骨架：cli-agent-orchestrator v2.4.1 ｜ 许可证：Apache-2.0 + MIT（角色派生）_
